...
`bytes` is Scriptling's binary data type — an immutable sequence of byte values (0–255). It is the canonical representation for raw binary data and is returned by [`hashlib.digest()`](../../math-numbers/hashlib/), [`hmac.digest()`](../../math-numbers/hmac/), [`base64.b64decode()`](../../math-numbers/base64/), and [`msgpack.packb()`](../msgpack/).
...
- [msgpack](../msgpack/): binary serialisation built on `bytes`.
- [base64](../../math-numbers/base64/): Base64 encode/decode.
- [hashlib](../../math-numbers/hashlib/): `.digest()` returns `bytes`.
- [hmac](../../math-numbers/hmac/): `.digest()` returns `bytes`.
