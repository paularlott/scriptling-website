...
aliases:
  - /reference/libraries/scriptling/networking/websocket/
---
...
- [scriptling.runtime.http](/reference/libraries/runtime/http/): register server-side WebSocket endpoints with `runtime.http.websocket()`
