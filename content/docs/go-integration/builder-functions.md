...
Library and class builders support typed variadics in the same way. The library-specific `FunctionFromVariadicWithHelp` helper is another option when adapting an existing variadic function; see [Builder Libraries](../builder-libraries/).
...
- [Native Functions](../native-functions/) - Direct object-level function control
