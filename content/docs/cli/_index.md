...
- **Custom libraries**: Libraries are loaded automatically from the script's directory (or cwd for interactive/stdin mode). Use `--libpath` to add extra search directories.
