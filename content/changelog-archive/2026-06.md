---
title: Changelog Archive - June 2026
linkTitle: June 2026
description: Archived Scriptling release history for June 2026.
tags: [changelog]
date: 2026-06-30
layout: changelog
---
...
[Plugin Server Mode](../../docs/cli/plugin-server/) docs.
...
- The AI Client method reference (completion, streaming, embeddings, Responses API, Pipeline, etc.) has been split into its own [Client](../../reference/libraries/ai/client/) page for easier navigation
{{< /changelog-item >}}
