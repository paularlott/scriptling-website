...
resource: https://scriptling.dev/docs/tutorials/fetcher-plugin/
sources:
    - resource: https://scriptling.dev/docs/tutorials/fetcher-plugin/
status: stable
tags:
...
- [Plugin Fetchers](https://scriptling.dev/okf/scriptling-docs/plugins/fetchers.md) — the full serving contract,
  error typing, and caching rules.
- [Writing a Go Plugin](https://scriptling.dev/okf/scriptling-docs/tutorials/go-plugin.md) — functions and classes
  without the fetcher half.
- [JSON-RPC Protocol](https://scriptling.dev/okf/scriptling-docs/plugins/protocol.md) — `fetch.read` and
