...
resource: https://scriptling.dev/docs/plugins/fetchers/
sources:
    - resource: https://scriptling.dev/docs/plugins/fetchers/
status: stable
tags:
...
[loading plugins](https://scriptling.dev/okf/scriptling-docs/cli/command-line-options.md#loading-plugins) for the
...
[`scriptling.package` library](https://scriptling.dev/okf/scriptling-docs/cli/packages.md#using-packages-in-code),
...
The [fetcher plugin tutorial](https://scriptling.dev/okf/scriptling-docs/tutorials/fetcher-plugin.md) walks through a
...
the [fetcher plugin tutorial](https://scriptling.dev/okf/scriptling-docs/tutorials/fetcher-plugin.md) walks through it,
...
sources](https://scriptling.dev/okf/scriptling-docs/cli/plugin-server.md#serving-sources-fetchers).
...
See [C Plugins](https://scriptling.dev/okf/scriptling-docs/plugins/c-plugins.md) for the handler contracts and the
...
[fetcher plugins in the plugin manager docs](https://scriptling.dev/okf/scriptling-docs/plugins/host-integration.md#fetcher-plugins)
...
rest of the [plugin protocol](https://scriptling.dev/okf/scriptling-docs/plugins/protocol.md): `fetch.read` and
