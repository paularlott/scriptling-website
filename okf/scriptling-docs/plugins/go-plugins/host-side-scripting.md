...
Host-side scripts have no access to Go code or the plugin process. If you need to call back into the plugin, use a [custom wrapper](client-wrappers.md) instead.
