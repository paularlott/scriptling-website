...
resource: https://scriptling.dev/docs/go-integration/builder-libraries/
sources:
    - resource: https://scriptling.dev/docs/go-integration/builder-libraries/
status: stable
tags:
...
- [Native Libraries](https://scriptling.dev/okf/scriptling-docs/go-integration/native-libraries.md) - Direct control with maximum performance
