...
The database plugins ship with Scriptling in every release form: compiled into the default `scriptling` build, omitted from `scriptling-slim`, selectable individually with build tags, or as external plugin binaries from the release page (one `plugins-<os>-<arch>.zip` per platform, containing all four binaries named plainly; unzip it and point `--plugin-dir` at the folder). See the [database libraries reference](https://scriptling.dev/okf/scriptling-libraries/databases.md) for the full APIs.
...
- [Using Plugins](https://scriptling.dev/okf/scriptling-docs/plugins/using.md) - Load plugin directories and call plugin libraries.
- [Plugin Manager](https://scriptling.dev/okf/scriptling-docs/plugins/host-integration.md) - Enable plugins in applications embedding Scriptling.
- [Go Plugins](https://scriptling.dev/okf/scriptling-docs/plugins/go-plugins.md) - Register functions, classes, and constants in a Go plugin.
  - [Client Wrappers](https://scriptling.dev/okf/scriptling-docs/plugins/go-plugins/client-wrappers.md) - Auto-generated proxies and custom Scriptling wrappers.
  - [Host-Side Scripting](https://scriptling.dev/okf/scriptling-docs/plugins/go-plugins/host-side-scripting.md) - Pure Scriptling functions and classes on the host.
- [C Plugins](https://scriptling.dev/okf/scriptling-docs/plugins/c-plugins.md) - Build plugins in C using the single-header SDK.
...
no compiled binary required. See [Plugin Server Mode](https://scriptling.dev/okf/scriptling-docs/cli/plugin-server.md) in
the CLI reference.
