...
- [Writing MCP Tools (legacy format)](https://scriptling.dev/okf/scriptling-libraries/scriptling/mcp/writing-mcp-tools.md) — The `.toml` + `.py` format reference
