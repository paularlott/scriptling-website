...
resource: https://scriptling.dev/reference/libraries/scriptling/messaging/telegram/
sources:
    - resource: https://scriptling.dev/reference/libraries/scriptling/messaging/telegram/
status: stable
tags:
