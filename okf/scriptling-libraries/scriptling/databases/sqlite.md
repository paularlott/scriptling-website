...
resource: https://scriptling.dev/reference/libraries/scriptling/databases/sqlite/
sources:
    - resource: https://scriptling.dev/reference/libraries/scriptling/databases/sqlite/
status: stable
tags:
...
`conn.get_orm()` returns a lightweight table helper bound to the connection: `insert`/`select`/`update`/`delete`/`count`/`tables()` over dict-shaped rows, with SQL generation following the backend. See the [Relational ORM](https://scriptling.dev/okf/scriptling-libraries/scriptling/databases/orm.md) page for the full reference.

## See Also

- [SQL](https://scriptling.dev/okf/scriptling-libraries/scriptling/databases/sql.md): the same API over MySQL, MariaDB and PostgreSQL
- [Database Libraries](https://scriptling.dev/okf/scriptling-libraries/scriptling/databases/sqlite.md): all four backends, two API shapes
