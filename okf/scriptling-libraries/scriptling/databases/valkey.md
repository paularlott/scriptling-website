...
resource: https://scriptling.dev/reference/libraries/scriptling/databases/valkey/
sources:
    - resource: https://scriptling.dev/reference/libraries/scriptling/databases/valkey/
status: stable
tags:
...
`scriptling.valkey` connects to Valkey or Redis servers: one server, a cluster, or a master behind sentinels. The string-KV core is mirrored exactly by [scriptling.badgerdb](https://scriptling.dev/okf/scriptling-libraries/scriptling/databases/badgerdb.md), so those scripts move between a shared cache and local storage by changing the connect line and nothing else: strings, hashes, batch operations, counters and TTLs. Sets, queues, database selection, flushes and the cluster/sentinel modes are valkey-only: they use native redis features an embedded store has no counterpart for.
...
Hashes are part of the mirrored core: [badgerdb](https://scriptling.dev/okf/scriptling-libraries/scriptling/databases/badgerdb.md) implements the
...
- [BadgerDB](https://scriptling.dev/okf/scriptling-libraries/scriptling/databases/badgerdb.md): the same string-KV core, embedded
- [Database Libraries](https://scriptling.dev/okf/scriptling-libraries/scriptling/databases/valkey.md): all four backends, two API shapes
