...
| [SQL](https://scriptling.dev/okf/scriptling-libraries/databases/sql.md) | `scriptling.sql` | relational | MySQL, MariaDB, PostgreSQL |
| [Valkey](https://scriptling.dev/okf/scriptling-libraries/databases/valkey.md) | `scriptling.valkey` | key/value | Valkey and Redis servers |
