...
resource: https://scriptling.dev/reference/libraries/package/
sources:
    - resource: https://scriptling.dev/reference/libraries/package/
status: stable
tags:
...
Read a packaged file as `str` or [`bytes`](https://scriptling.dev/okf/scriptling-libraries/data-formats/bytes.md) respectively. Paths are package-relative; a leading slash is removed and path traversal is cleaned before access.
...
- [Runtime MCP](https://scriptling.dev/okf/scriptling-libraries/runtime/mcp.md): tools packaged in app bundles
- [Libraries](https://scriptling.dev/okf/scriptling-libraries/package.md): library availability and registration overview
