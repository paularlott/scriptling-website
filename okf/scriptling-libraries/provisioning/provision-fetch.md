...
resource: https://scriptling.dev/reference/libraries/provisioning/provision-fetch/
sources:
    - resource: https://scriptling.dev/reference/libraries/provisioning/provision-fetch/
status: stable
tags:
...
- [scriptling.provision.file](https://scriptling.dev/okf/scriptling-libraries/provisioning/provision-file.md): provision plain files and managed blocks without fetching them remotely
