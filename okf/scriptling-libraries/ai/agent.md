...
resource: https://scriptling.dev/reference/libraries/ai/agent/
sources:
    - resource: https://scriptling.dev/reference/libraries/ai/agent/
status: stable
tags:
...
Runs an interactive CLI session. Requires the `scriptling.ai.agent.interact` library to be imported, which adds this method to the `Agent` class: see [scriptling.ai.agent.interact](https://scriptling.dev/okf/scriptling-libraries/ai/interact.md) for the full reference.
