...
resource: https://scriptling.dev/reference/libraries/ai/ai/
sources:
    - resource: https://scriptling.dev/reference/libraries/ai/ai/
status: stable
tags:
...
- [scriptling.ai.Client](https://scriptling.dev/okf/scriptling-libraries/ai/client.md): Create clients and make completions, embeddings, and Responses API calls
...
- [scriptling.ai.agent.interact](https://scriptling.dev/okf/scriptling-libraries/ai/interact.md): Interactive terminal session for agents
...
For the full client method reference (completion, streaming, parallel, embeddings, Responses API, background processing), see [scriptling.ai.Client](https://scriptling.dev/okf/scriptling-libraries/ai/client.md).

## Available Functions

| Function | Description |
|----------|-------------|
| `Client(base_url, **kwargs)` | Create an AI client for API interactions: see [scriptling.ai.Client](https://scriptling.dev/okf/scriptling-libraries/ai/client.md) |
...
Creates a new tool registry for building OpenAI-compatible tool schemas for AI agents. This is a re-export of the `Registry` class from [scriptling.ai.tools](https://scriptling.dev/okf/scriptling-libraries/ai/tools.md): `ai.ToolRegistry()` and `scriptling.ai.tools.Registry()` both return a `Registry` instance.
...
- [scriptling.ai.Client](https://scriptling.dev/okf/scriptling-libraries/ai/client.md): Full client method reference (completion, streaming, embeddings, Responses API)
- [scriptling.ai.agent](https://scriptling.dev/okf/scriptling-libraries/ai/agent.md): Agentic AI loop with automatic tool execution
- [scriptling.ai.memory](https://scriptling.dev/okf/scriptling-libraries/ai/memory.md): Long-term memory store for AI agents
