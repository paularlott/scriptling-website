...
resource: https://scriptling.dev/reference/libraries/ai/memory/
sources:
    - resource: https://scriptling.dev/reference/libraries/ai/memory/
status: stable
tags:
...
The simplest way to give an agent memory is to pass `memory=` to `Agent()`. The agent wires up the tools and augments the system prompt automatically: see [scriptling.ai.agent Memory Integration](https://scriptling.dev/okf/scriptling-libraries/ai/agent.md#memory-integration).
...
- [scriptling.runtime.kv](https://scriptling.dev/okf/scriptling-libraries/runtime/kv.md): KV store backing the memory system
- [scriptling.ai.agent](https://scriptling.dev/okf/scriptling-libraries/ai/agent.md): Agent with automatic memory integration
