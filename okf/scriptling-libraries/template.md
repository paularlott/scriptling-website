...
resource: https://scriptling.dev/reference/libraries/template/
sources:
    - resource: https://scriptling.dev/reference/libraries/template/
status: stable
tags:
...
|---------|--------|-------------|
| [`scriptling.template.html`](https://scriptling.dev/okf/scriptling-libraries/template/html.md) | `import scriptling.template.html as html` | `html/template`: automatic HTML escaping |
| [`scriptling.template.text`](https://scriptling.dev/okf/scriptling-libraries/template/text.md) | `import scriptling.template.text as text` | `text/template`: no escaping, plain text output |
...
- [scriptling.markdown](https://scriptling.dev/okf/scriptling-libraries/utilities/markdown.md) - Markdown to HTML conversion
