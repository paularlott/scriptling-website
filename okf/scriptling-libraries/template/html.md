...
resource: https://scriptling.dev/reference/libraries/template/html/
sources:
    - resource: https://scriptling.dev/reference/libraries/template/html/
status: stable
tags:
...
- [scriptling.template.text](https://scriptling.dev/okf/scriptling-libraries/template/text.md) - Unescaped template rendering for non-HTML output
- [scriptling.markdown](https://scriptling.dev/okf/scriptling-libraries/utilities/markdown.md) - Convert Markdown to HTML before rendering it into a template
