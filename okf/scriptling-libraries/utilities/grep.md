...
resource: https://scriptling.dev/reference/libraries/utilities/grep/
sources:
    - resource: https://scriptling.dev/reference/libraries/utilities/grep/
status: stable
tags:
...
- [scriptling.sed](https://scriptling.dev/okf/scriptling-libraries/utilities/sed.md) - Pair with grep to find-then-transform file content
