...
resource: https://scriptling.dev/reference/libraries/utilities/sed/
sources:
    - resource: https://scriptling.dev/reference/libraries/utilities/sed/
status: stable
tags:
...
- [scriptling.grep](https://scriptling.dev/okf/scriptling-libraries/utilities/grep.md) - Pair with sed to find-then-transform file content
