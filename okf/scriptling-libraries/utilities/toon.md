...
resource: https://scriptling.dev/reference/libraries/utilities/toon/
sources:
    - resource: https://scriptling.dev/reference/libraries/utilities/toon/
status: stable
tags:
...
- [scriptling.similarity](https://scriptling.dev/okf/scriptling-libraries/utilities/similarity.md) - Fuzzy matching and tokenization, often used alongside decoded TOON records
