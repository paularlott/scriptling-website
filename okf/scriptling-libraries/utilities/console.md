...
resource: https://scriptling.dev/reference/libraries/utilities/console/
sources:
    - resource: https://scriptling.dev/reference/libraries/utilities/console/
status: stable
tags:
...
- [scriptling.ai.agent.interact](https://scriptling.dev/okf/scriptling-libraries/ai/interact.md) - Interactive agent loop using this library
