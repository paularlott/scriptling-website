...
resource: https://scriptling.dev/reference/libraries/utilities/xml/
sources:
    - resource: https://scriptling.dev/reference/libraries/utilities/xml/
status: stable
tags:
...
- [scriptling.csv](https://scriptling.dev/okf/scriptling-libraries/utilities/csv.md): CSV parsing and formatting
