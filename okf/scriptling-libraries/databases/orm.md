...
resource: https://scriptling.dev/reference/libraries/databases/orm/
sources:
    - resource: https://scriptling.dev/reference/libraries/databases/orm/
status: stable
tags:
...
Both relational plugins, [sqlite](https://scriptling.dev/okf/scriptling-libraries/databases/sqlite.md) and [sql](https://scriptling.dev/okf/scriptling-libraries/databases/sql.md), hand out the same ORM from `conn.get_orm()`. It has three layers, each useful on its own:
...
- [sqlite](https://scriptling.dev/okf/scriptling-libraries/databases/sqlite.md) and [sql](https://scriptling.dev/okf/scriptling-libraries/databases/sql.md): the connections that hand out ORMs
- [Database Libraries](https://scriptling.dev/okf/scriptling-libraries/databases/orm.md): all four backends, two API shapes
