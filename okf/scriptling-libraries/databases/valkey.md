...
resource: https://scriptling.dev/reference/libraries/databases/valkey/
sources:
    - resource: https://scriptling.dev/reference/libraries/databases/valkey/
status: stable
tags:
...
Hashes are part of the mirrored core: [badgerdb](https://scriptling.dev/okf/scriptling-libraries/databases/badgerdb.md) implements the
...
- [BadgerDB](https://scriptling.dev/okf/scriptling-libraries/databases/badgerdb.md): the same string-KV core, embedded
- [Database Libraries](https://scriptling.dev/okf/scriptling-libraries/databases/valkey.md): all four backends, two API shapes
