...
resource: https://scriptling.dev/reference/libraries/databases/badgerdb/
sources:
    - resource: https://scriptling.dev/reference/libraries/databases/badgerdb/
status: stable
tags:
...
Identical surface to the [valkey Client](https://scriptling.dev/okf/scriptling-libraries/databases/valkey.md#client):
...
- [Valkey](https://scriptling.dev/okf/scriptling-libraries/databases/valkey.md): the same string-KV core against a server, plus sets and queues
- [Database Libraries](https://scriptling.dev/okf/scriptling-libraries/databases/badgerdb.md): all four backends, two API shapes
