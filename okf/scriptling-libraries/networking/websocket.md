...
resource: https://scriptling.dev/reference/libraries/networking/websocket/
sources:
    - resource: https://scriptling.dev/reference/libraries/networking/websocket/
status: stable
tags:
...
- [scriptling.runtime.http](https://scriptling.dev/okf/scriptling-libraries/runtime/http.md): register server-side WebSocket endpoints with `runtime.http.websocket()`
