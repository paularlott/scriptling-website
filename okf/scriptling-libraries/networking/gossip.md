...
resource: https://scriptling.dev/reference/libraries/networking/gossip/
sources:
    - resource: https://scriptling.dev/reference/libraries/networking/gossip/
status: stable
tags:
...
- [scriptling.net.unicast](https://scriptling.dev/okf/scriptling-libraries/networking/unicast.md): direct point-to-point UDP/TCP messaging
- [scriptling.net.multicast](https://scriptling.dev/okf/scriptling-libraries/networking/multicast.md): one-to-many UDP group messaging
- [scriptling.net.resolve](https://scriptling.dev/okf/scriptling-libraries/networking/resolve.md): DNS and SRV record resolution
