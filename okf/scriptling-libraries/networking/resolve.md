...
resource: https://scriptling.dev/reference/libraries/networking/resolve/
sources:
    - resource: https://scriptling.dev/reference/libraries/networking/resolve/
status: stable
tags:
...
- [scriptling.net.websocket](https://scriptling.dev/okf/scriptling-libraries/networking/websocket.md): WebSocket client library
